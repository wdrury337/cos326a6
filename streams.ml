 ...
 *   https://github.com/ocaml/num/blob/master/src/num.mli
 *
 * If you have OPAM, you can install this library with the command 
 *   % opam install num
 * Otherwise, you can install manually from here: 
